...
### 5. Test with an AI Agent (e.g., Claude Desktop)
...
```
*Note: Make sure to adjust the absolute path in `args` if necessary, and restart Claude Desktop after saving the config.*
